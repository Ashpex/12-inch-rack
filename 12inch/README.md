...
Generated from the original `10inch/` models for the rack shown in `context/`.
...
- `TL-SG108E-V5-12INCH-RACK-MOUNT.3mf`
- `Tiny-Rack-Mount-no-Keystone-12inch-light-v2.3mf`
...
Use `Tiny-Rack-Mount-no-Keystone-12inch-light-v2.3mf` for Bambu Studio. This version uses slicer-friendly axes: width on X, depth on Y, and the 1U height on Z.
...
`TL-SG108E-V5-12INCH-RACK-MOUNT.3mf` was generated from `10inch/TL-SG108E+V5+10i+RM.3mf`. It targets `277.4 mm` overall width, includes a white material color in the 3MF, and uses a `4.0 mm` rack/base plate thickness.
