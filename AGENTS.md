...
The Bambu-oriented file uses slicer-friendly axes: width on X, depth on Y, and 1U height on Z.
...
- Nozzle: `250 C` initial layer, `250 C` other layers.
- Textured PEI bed: `75 C` for SG108E; `75 C` for the ThinkCentre Tiny mount.
- Layer height: `0.20 mm`.
- Walls: `4` for SG108E, `5` for the taller ThinkCentre Tiny mount.
